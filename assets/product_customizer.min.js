...
Object.assign( window.anthology.customizer.handlers, {
    ...
    initials: function ( customization, updatePropertyField ) {
        
        var initialsField = customization.el.querySelector('#keys-input-front');
     
        registerEvent('input', initialsField, function( evt ) {
            this.updatePropertyField( evt.target.value )
        }, { updatePropertyField: updatePropertyField })
        ...
        registerEvent('Customization:onThisTabSelect', customization.tab, function( evt ){
            ...
            var customization = evt.details.customization
            var { updatePropertyField, initialsField } = this

            updatePropertyField( initialsField.value )

        }, { updatePropertyField: updatePropertyField, initialsField: initialsField })
...
pc.onReady = function ( _pc ) {
   ...
   if ( custom_tags.includes('Initials') ) {
        _pc.addCustomizationHandler('initials', window.anthology.customizer.handlers.initials )
    }
